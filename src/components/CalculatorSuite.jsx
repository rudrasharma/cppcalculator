...
export default function CalculatorSuite() {
  // Use localStorage to remember choice, default to 'landing'
    ...
    <div className="min-h-screen bg-slate-50 pb-24 md:pb-0"> 
      ...
      <nav className="hidden md:block bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          {/* Only show tab switcher if NOT on landing page */}
          {view !== 'landing' && (
        ...
        <main className="max-w-6xl mx-auto px-6 py-12 md:py-20 animate-fade-in">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-xl mx-auto font-medium">
              Select a tool below to get instant, privacy-first estimates of your Canadian government benefits.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {TABS.map((tool) => (
              ...
              >
                ...
                <h3 className="text-2xl font-black text-slate-900 mb-3">{tool.label}</h3>
                <p className="text-slate-500 mb-8 leading-relaxed font-medium">{tool.description}</p>
      ...
      {view !== 'landing' && (
        <>
          <div className="hidden md:block max-w-5xl mx-auto px-8 pt-8 pb-2 animate-fade-in">
          ...
          {/* MOBILE BOTTOM NAV - Only shown when in a tool */}
