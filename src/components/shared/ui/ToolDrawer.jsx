...
export const ToolDrawer = ({ isOpen, onClose, activeId, onSelect, isSuite = false }) => {
    ...
    return (
        <div className="fixed inset-0 z-[10001] md:hidden">
            ...
            {/* Bottom Sheet */}
            <div 
                className={`absolute bottom-0 left-0 right-0 bg-white rounded-t-[2.5rem] shadow-2xl transition-transform duration-300 ease-out p-6 pb-safe max-h-[90dvh] overflow-y-auto overscroll-contain ${isOpen ? 'translate-y-0' : 'translate-y-full'}`}
            >
                {/* Handle */}
