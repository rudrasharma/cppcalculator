...
export const SmithInputs = ({
    homeValue = 0, setHomeValue,
    mortgageBalance = 0, setMortgageBalance,
    mortgageRate = 0, setMortgageRate,
    helocRate = 0, setHelocRate,
    marginalTaxRate = 0, setMarginalTaxRate,
    capitalGainsRate = 0, setCapitalGainsRate,
    dividendYield = 0, setDividendYield,
    showAdvanced = false, setShowAdvanced,
    initialLumpSum = 0, setInitialLumpSum,
    isOverLimit = false, absoluteMaxLumpSum = 0,
    amortizationYears = 25, setAmortizationYears,
    readvanceTolerance = 1.0, setReadvanceTolerance,
    dividendTaxRate = 0.15, setDividendTaxRate,
    capitalizeInterest = true, setCapitalizeInterest,
    taxRefundAllocation = 'portfolio', setTaxRefundAllocation,
    dividendAllocation = 'portfolio', setDividendAllocation,
    currency
}) => {
    return (
