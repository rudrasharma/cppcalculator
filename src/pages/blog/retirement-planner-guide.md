...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Which account should I draw down first in retirement in Canada?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "While everyone's tax situation is different, a common strategy is to draw down Non-Registered accounts first (to minimize taxable capital gains over time), followed by RRSPs (which are fully taxable), and finally TFSAs (which grow tax-free and are untouched by income testing like the OAS clawback)."
      }
    },
    {
      "@type": "Question",
      "name": "How is the OAS clawback calculated in retirement planning?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The OAS clawback (Old Age Security pension recovery tax) is triggered when your net world income exceeds a specific threshold (e.g., $90,997 for 2024). Above this amount, you must repay 15% of the excess income. Our Retirement Planner automatically calculates this clawback year-by-year based on your projected taxable withdrawals."
      }
    }
  ]
}
...
That's why we built the holistic **[Retirement Planner](/retirement-planner/)**. This guide will show you exactly how to use it to project your cash flow, minimize tax drag, and ensure your money outlives you.
...
1. **RRSP / RRIF**: Withdrawals are fully taxable as regular income. By age 71, you must convert your RRSP to a RRIF and take minimum annual withdrawals, which can unintentionally push you into higher tax brackets.
2. **LIRA (Locked-In Retirement Account)**: Similar to an RRSP, but holds funds transferred from a former employer's pension plan. Withdrawals are highly regulated and fully taxable.
3. **TFSA (Tax-Free Savings Account)**: The holy grail of retirement accounts. Withdrawals are completely tax-free and **do not** count toward income-tested benefits like the OAS clawback or GIS.
4. **Non-Registered**: Investments held in standard cash or margin accounts. Only 50% of capital gains (or 66.67% under new rules for large gains) are taxable.
...
### Step 1: The Basics
Navigate to the [Retirement Planner](/retirement-planner/) and start by entering your demographic data. 
...
We recommend running your numbers through the [LoonieFi Retirement Planner](/retirement-planner/) at least once a year. By simulating your asset drawdown today, you can make the precise course corrections needed to ensure a wealthy, stress-free tomorrow.
